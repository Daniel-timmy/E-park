...
#     space_list = []
#     for rSpace in sp:
#         space = Space(space_name=rSpace, time_left=0, status='empty')
#         space_list.append(space)
#     lot = Lot(lot_name=rlot, space=space_list)
#     db.insert(lot)
#
# obj = db.get_lot(name='EDU')
# print(str(obj))
# print(obj[0].lot_name)
# pp = []
# for sp in obj:
#     for spp in sp.space:
#         pp.append(spp.space_name)
# print(pp)
count = db.get_empty_space_count()
# for ct in count:
print(count)
